...
function generateStructure()
{
    ...
    var overwrite = $F("cbo_generation_mode");
    var overwriteFolder = $F("txt_overwrite_folder");

    var params = "directory=" + directory + "&host=" + host + "&url=" + url + "&database=" + database + "&user=" + user + "&password=" + password + "&overwrite=" + overwrite + "&overwrite_folder=" + overwriteFolder;
