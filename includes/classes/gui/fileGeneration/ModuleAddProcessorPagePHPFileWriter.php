 ...
 * @author suyash
 */
class ModuleAddProcessorPagePHPFileWriter extends GenericPHPFileWriter
{
	...
	$displayFunctionName = BaseGuiPHPFileWriter::getAddFunctionName($tableName);
	$staticVariableName = PageTitlePHPFileWriter::getVariableForAddPageTitle($tableName);
	$parameterList = $this->tableEntity->getPhpCommaNonPrimaryParameterList();
