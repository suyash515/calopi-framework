...
class UrlConfiguration
{
    ...
    public static function getCodeIgniterUrl($module, $action, $folder = "", $params = "")
    {
        $url = "";
    ...
    {
        return "<link href='".Configuration::$URL."includes/css/$cssFile.css' rel='stylesheet' type='text/css' />";
    }
