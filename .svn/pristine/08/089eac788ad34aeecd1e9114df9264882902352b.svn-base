...
class QueryBuilder
{
    ...
    {
        $queryJoin = new QueryJoin($table, QueryJoin::$LEFT_JOIN, $leftTable, $leftField, $rightTable, $rightField, array(), $tableAlias);
    ...
    {
        $queryJoin = new QueryJoin($table, QueryJoin::$JOIN, $leftTable, $leftField, $rightTable, $rightField, $andConditionArray);
