...
class DateGuiUtility
{
    ...
    public function getPreselectedTimeChooserIncluding24Hour($selectedHour, $selectedMinute, $suffixId, $minuteInterval = "")
    {
        $output = "";
        ...
        $output .= "<td>:</td>";
        $output .= "<td>";
        $output .= $this->getPrelectedMinuteComboIncluding24($selectedMinute, $selectedHour, $minuteComboId, $dateUtility, $minuteInterval);
        $output .= "</td>";
        $output .= "</tr>";
        $output .= "</table>";
    ...
    private function getPrelectedMinuteComboIncluding24($selectedMinute, $selectedHour, $comboId, $dateUtility, $interval = "")
    {
        $output = "";
